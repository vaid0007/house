...
<!-- Mirrored from unifato.com/hosue/apartment by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Dec 2025 07:43:36 GMT -->
<head>
     <meta charset="UTF-8">
      ...
      <div class="row">
        <div class="col-lg-5">
            <div class="inner-heading header-heading">
                ...
                <p><a href="./">Home <i class="fa-solid fa-angle-right"></i></a> <a href="apartments">Service</a></p>
            </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-lg-none d-block" data-aos="zoom-in-up" data-aos-duration="1100">
          <div class="apartment-boxarea">
            ...
            <div class="content-area">
              <a href="apartments">Villa Grean Complex</a>
              <div class="space16"></div>
              <ul>
                <li><a href="#"><img src="assets/img/icons/bed-icon1.svg" alt="">x2</a> <span> | </span></li>
                <li><a href="#"><img src="assets/img/icons/bat-icon1.svg" alt="">x2</a> <span> | </span></li>
                <li><a href="#"><img src="assets/img/icons/squre-icon1.svg" alt="">1100 sq</a></li>
              </ul>
            </div>
            <div class="arrow">
              <a href="apartments">View</a>
        ...
        <div class="col-lg-8 col-md-12" data-aos="zoom-in-up" data-aos-duration="1200">
            <div class="apartment-boxarea">
              ...
              <div class="content-area">
                <a href="apartments">Modern Industrial Apartement</a>
                <div class="space16"></div>
                <ul>
                  <li><a href="#"><img src="assets/img/icons/bed-icon1.svg" alt="">x2</a> <span> | </span></li>
                  <li><a href="#"><img src="assets/img/icons/bat-icon1.svg" alt="">x2</a> <span> | </span></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="800">
          <div class="amenities-boxarea">
            ...
            <div class="content-area">
              <a href="apartments">New Construction</a>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000">
          ...
          <div class="amenities-boxarea">
            ...
            <div class="space32"></div>
            <div class="content-area">
              <a href="apartments">Swimming Pool</a>
              <div class="space18"></div>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1100">
          <div class="amenities-boxarea">
            ...
            <div class="space32"></div>
            <div class="content-area">
              <a href="apartments">Fitness Facilities</a>
              <div class="space18"></div>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1200">
          ...
          <div class="amenities-boxarea">
            ...
            <div class="space32"></div>
            <div class="content-area">
              <a href="apartments">Eco Construction</a>
              <div class="space18"></div>
